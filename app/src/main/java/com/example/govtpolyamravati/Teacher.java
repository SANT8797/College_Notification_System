...
public class Teacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Teacher.this, ViewImage.class);
        ...
        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(Teacher.this, "Upload in progress", Toast.LENGTH_LONG).show();
                } else {
                    uploadImage();
                }
            }
    ...
    private void uploadImage() {
        if (imgUrl != null) {
            ...
            mUploadTask = fileReference.putFile(imgUrl)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>()
                            {
                                ...
                                public void onSuccess(Uri uri)
                                {
                                    ...
                                    Toast.makeText(Teacher.this, "Upload successfully", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Teacher.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(Teacher.this, "No file selected", Toast.LENGTH_SHORT).show();
        }
    }
}
